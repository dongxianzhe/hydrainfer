...
class BlockAllocator:
    ...
    def get_metrics(self) -> BlockAllocatorMetrics:
        n_used_blocks = self.total_blocks - len(self.free_blocks)
        return BlockAllocatorMetrics(
            n_used_blocks=n_used_blocks, 
            n_total_blocks=self.total_blocks, 
            block_usage=n_used_blocks / self.total_blocks, 
        )
