...
from dxz.layer.attention import Attention, FlashAttention
...
def test_flash_attention(
    ...
    attention = Attention(n_qo_heads, n_kv_heads, head_size).to(device)
    flashattention = FlashAttention(n_qo_heads, n_kv_heads, head_size).to(device)
