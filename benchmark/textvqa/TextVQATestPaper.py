...
class Question:
    """
    https://huggingface.co/datasets/lmms-lab/textvqa/viewer/default/validation
...
class TextVQATestPaper:
    def __init__(self):
        ...
        assert len(self.questions) == 5000
    ...
    def mark_paper(self):
        ...
        for question in self.questions:
            question.reference_answers = [processor(ref_ans) for ref_ans in question.reference_answers]
            question.answer = processor(question.answer)
